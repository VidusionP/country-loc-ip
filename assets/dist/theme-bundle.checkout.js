...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_request__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_countries__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__api_product__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_product_attributes__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_search__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__api_cart__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__api_cookie__ = __webpack_require__(116);
var internals={};/**
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hooks__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_utils__ = __webpack_require__(109);
function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function')}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called')}return call&&(typeof call==='object'||typeof call==='function')?call:self}function _inherits(subClass,superClass){if(typeof superClass!=='function'&&superClass!==null){throw new TypeError('Super expression must either be null or a function, not '+typeof superClass)}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass}var _class=function(_Base){_inherits(_class,_Base);/**
     * @Constructor
     */function _class(version){_classCallCheck(this,_class);// set up class variables
var _this=_possibleConstructorReturn(this,_Base.call(this,version));// call parent
...
var decodeComponent = __webpack_require__(113);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hooks__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hooks__ = __webpack_require__(16);
function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function')}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError('this hasn\'t been initialised - super() hasn\'t been called')}return call&&(typeof call==='object'||typeof call==='function')?call:self}function _inherits(subClass,superClass){if(typeof superClass!=='function'&&superClass!==null){throw new TypeError('Super expression must either be null or a function, not '+typeof superClass)}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass}var _class=function(_Base){_inherits(_class,_Base);/**
     * @Constructor
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tools_image__ = __webpack_require__(118);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hooks__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tools__ = __webpack_require__(117);
...
var _typeof=typeof Symbol==='function'&&typeof Symbol.iterator==='symbol'?function(obj){return typeof obj}:function(obj){return obj&&typeof Symbol==='function'&&obj.constructor===Symbol&&obj!==Symbol.prototype?'symbol':typeof obj};var StencilUtils={hooks:__WEBPACK_IMPORTED_MODULE_0__hooks__["a" /* default */],api:__WEBPACK_IMPORTED_MODULE_1__api__["a" /* default */],tools:__WEBPACK_IMPORTED_MODULE_2__tools__["a" /* default */]};/* harmony default export */ __webpack_exports__["b"] = (StencilUtils);/* global define */(function(root){if(typeof define==='function'&&__webpack_require__(49)&&root){// Ignores below for https://github.com/eslint/eslint/issues/5150
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hooks_cart__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__hooks_cookie__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hooks_currency_selector__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__hooks_product__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hooks_search__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__hooks_faceted_search__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__hooks_sort_by__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sweetalert2___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_sweetalert2__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bigcommerce_stencil_utils__ = __webpack_require__(12);
//sandbox : 998
//us: 5229
//ca: 3165
var allureException=['coco','rose','adele','angelina','jessica','selena','taylor','julia','nicole','gwyneth','ev7914','tl6814','ev5714','mo5514','mo7608','ev5512','ev5706','ev6810','eg6612','eh16','mh2206','sh5206','ep3608','mh2216','maya','noya'];var enableSITimer;var shippingItem=null;var shippingItems=null;var cartItems=null;var sku='SKUSI';var skus=[];var teamdeskItems=null;var teamdeskPOItems=null;var redirectUrl='/checkout';var sioParam;var pShippingGroup={};var isPopup=false;/**
 ...
 */function monthDiff(d1,d2){var months;months=(d2.getFullYear()-d1.getFullYear())*12;months-=d1.getMonth();months+=d2.getMonth();return months<=0?0:months}function findShippingInsurance(arr){var result=[];for(var i=arr.length-1;i>=0;i--){if(arr[i].sku.includes('SKUSI')){result.push(arr[i])}}if(result.length==0){return null}else{return result}}/**
 * Get the inventory and po from teamdesk
 */function cartGetDelivery(){if(cartItems){// console.log(cartItems);
skus=cartItems.lineItems.physicalItems.map(function(i){var sku=i.sku;if(sku.indexOf('_N')==sku.length-2){sku=sku.slice(0,sku.length-2)}return encodeURIComponent(sku)});fetch('//shp-webserver.glitch.me/get-teamdesk',{method:'POST',headers:{'Content-Type':'application/json',accept:'application/json'},body:JSON.stringify({table:'Inventory',filter:'Any([SKU],\''+skus.join(',')+'\')'})}).then(function(r){return r.json()}).then(function(r){teamdeskItems=r;fetch('//shp-webserver.glitch.me/get-teamdesk',{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json'},body:JSON.stringify({table:'t_763479',options:'?filter=Any([SKU],\''+skus.join(',')+'\') and [Incoming Quantity]>0 and [Arrival Due Date]>ToDate(\'1/1/1\')&sort=Arrival Due Date//ASC'})}).then(function(r){return r.json()}).then(function(r){teamdeskPOItems=r;cartSetDelivery()}).catch(function(e){console.log(e);cartSetDelivery()})}).catch(function(e){return console.log(e)})}}/**
 * Fill in the delivery information
 */function cartSetDelivery(){if(teamdeskItems){var qtyChecked=[];var _loop=function _loop(index,_sku2){if(_sku2.indexOf('_N')==_sku2.length-2){_sku2=_sku2.slice(0,_sku2.length-2)}var item=teamdeskItems.find(function(s){return encodeURIComponent(s.SKU.toUpperCase())==_sku2.toUpperCase()});if(item){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('ul.product-options').find('.cart-delivery').length==0){var qty=cartItems.lineItems.physicalItems[index].quantity;var buff=0;if(qtyChecked[item.SKU]){buff=qtyChecked[item.SKU];qtyChecked[item.SKU]+=qty}else{qtyChecked[item.SKU]=qty}var content='<strong>Estimated ship out time:</strong><br/>';if(item['Total On Hand']==item['Available Quantity']){if(Number(item['Quantity USA'])>0){if(Number(item['Quantity USA'])-buff>0){content+='Immediately: quantity <strong>'+Math.min(item['Quantity USA']-buff,qty)+'</strong><br/>';qty=qty-Math.min(item['Quantity USA']-buff,qty);buff=0}else{buff-=Number(item['Quantity USA'])}}if(Number(item['Quantity Canada'])>0&&qty>0){if(Number(item['Quantity Canada'])-buff>0){content+='2-4 days: quantity <strong>'+Math.min(item['Quantity Canada']-buff,qty)+'</strong><br/>';qty=qty-Math.min(item['Quantity Canada']-buff,qty);buff=0}else{buff-=Number(item['Quantity Canada'])}}}else{if(Number(item['Available Quantity'])>0){if(Number(item['Available Quantity'])-buff>0){content+='1-4 days: quantity <strong>'+Math.min(item['Available Quantity']-buff,qty)+'</strong><br/>';qty=qty-Math.min(item['Available Quantity']-buff,qty);buff=0}else{buff-=Number(item['Available Quantity'])}}}if(item['Virtual Quantity']&&qty>0){if(item['Lock Status']!='Locked for processing'&&Number(item['Unlocked for sale quantity'])>0&&qty>0){if(Number(item['Unlocked for sale quantity'])-buff>0){content+='1 week later: quantity <strong>'+Math.min(item['Unlocked for sale quantity']-buff,qty)+'</strong><br/>';qty=qty-Math.min(item['Unlocked for sale quantity']-buff,qty);buff=0}else{buff-=Number(item['Unlocked for sale quantity'])}}var virtual={};if(Number(item['Quantity Incoming'])-2>0&&qty>0){if(Number(item['Quantity Incoming'])-2-buff>0){var inItems=teamdeskPOItems.filter(function(p){return p.SKU.toUpperCase()==item['SKU'].toUpperCase()});var i=0,totalP=buff,tempqty=qty;while(i<inItems.length&&tempqty>0){totalP+=Number(inItems[i]['Incoming Quantity']);tempqty=tempqty-Math.min(Number(inItems[i]['Incoming Quantity']),tempqty);i++}if(i>0){var inItem=inItems[i-1];var mdiff=monthDiff(new Date,new Date(inItem['Arrival Due Date']));if(mdiff==0){if(allureException.includes(inItem['Part Number'])){mdiff+=3}else{mdiff+=1}}else if(allureException.includes(inItem['Part Number'])){mdiff+=2}virtual[mdiff]=Math.min(totalP,qty);qty=tempqty;buff=0}}else{buff=buff-Number(item['Quantity Incoming'])+2}}if(qty>0){var m=item['Virtual Location'].slice(0,-1);if(virtual[m]){virtual[m]+=qty}else{virtual[m]=qty}}// console.log(virtual);
if(Object.keys(virtual).length>0){var options={year:'numeric',month:'long'};var vkeys=Object.keys(virtual).sort(function(a,b){return b-a});for(var _iterator2=vkeys,_isArray2=Array.isArray(_iterator2),_i2=0,_iterator2=_isArray2?_iterator2:_iterator2[Symbol.iterator]();;){var _ref3;if(_isArray2){if(_i2>=_iterator2.length)break;_ref3=_iterator2[_i2++]}else{_i2=_iterator2.next();if(_i2.done)break;_ref3=_i2.value}var key=_ref3;if(Number(key)){var date=new Date;date=new Date(date.getUTCFullYear(),date.getUTCMonth(),date.getUTCDate());date.setMonth(date.getMonth()+Number(key));content+=date.toLocaleDateString('en-US',options)+': quantity <strong>'+virtual[key]+'</strong><br/>'}else{content+=key.replace('_','-')+' months later: quantity <strong>'+virtual[key]+'</strong><br/>'}}}}if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('ul.product-options').length>0){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('ul.product-options').append('<li class="product-option cart-delivery">'+content+'</li>')}else{__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('.product-body').append('\n                            <ul class="product-options"><li class="product-option cart-delivery">'+content+'</li></ul>\n                        ')}}else{var _qty=cartItems.lineItems.physicalItems[index].quantity;if(qtyChecked[item.SKU]){qtyChecked[item.SKU]+=_qty}else{qtyChecked[item.SKU]=_qty}}}else if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('ul.product-options').find('.cart-delivery').length==0){cmhRushItems=['CMH','CMLACE','CMMONO','CMLACEPOLY','CMSKIN'];hairService=['style#221','style#222','style#231','style#232','style#233','style#234','style#251','style#331','style#332','style#334','style#335','style#341','style#342','style#343','style#551','style#552','Style #Your_Own','Online Services Pack'];var _content='';if(cmhRushItems.includes(_sku2.toUpperCase())){_content='<strong>Estimated ship out time:</strong><br/>3-month guaranteed delivery<br/>'}else if(hairService.includes(_sku2)){_content='<strong>Estimated ship out time:</strong><br/>Handling time 1-2 weeks<br/>'}__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.productList').find('li.productList-item').eq(index).find('ul.product-options').append('<div class="cart-delivery">'+_content+'</div>')}_sku=_sku2};for(var _iterator=skus.entries(),_isArray=Array.isArray(_iterator),_i=0,_iterator=_isArray?_iterator:_iterator[Symbol.iterator]();;){var _ref2;if(_isArray){if(_i>=_iterator.length)break;_ref2=_iterator[_i++]}else{_i=_iterator.next();if(_i.done)break;_ref2=_i.value}var _ref=_ref2;var index=_ref[0];var _sku=_ref[1];var cmhRushItems;var hairService;_loop(index,_sku)}}}/**
 * Show custom loading 
 * 
 * @param {string} content HTML string content
 */function showLoading(content){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.loadingNotification.customLoading').length==0){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.layout-main').append('\n        <div class="loadingNotification customLoading">\n            <div class="loadingNotification-label optimizedCheckout-loadingToaster">\n                <div class="spinner" />\n                <span class="label">\n                    '+content+'\n                </span>\n            </div>\n        </div>\n    ')}else{updateLoadingContent(content)}}/**
 * Hide custom loading
 */function hideLoading(){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.layout-main .loadingNotification.customLoading').remove()}/**
 * Update content of custom loading
 * 
 * @param {string} content HTML string content
 */function updateLoadingContent(content){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.layout-main .loadingNotification.customLoading').length>0){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.layout-main .loadingNotification.customLoading').find('.label').html(content)}else{showLoading(content)}}/**
 ...
 */function updateSI(element){if(element.checked){showLoading('Updating Shipping Insurance');var totalAmount=cartItems.baseAmount;var insurance=Math.floor(totalAmount*0.01);var url='/cart.php?action=add&sku=SKUSI-'+(insurance-9);__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(url,function(data){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}})}else{__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()({text:'You will NOT be covered for your order in case it is lost, damaged or stolen. Are you sure to remove this option?',type:'warning',showCancelButton:true}).then(function(){// remove item from cart
showLoading('Removing Shipping Insurance');cartRemoveSI(0,shippingItems,function(){if(isPopup){location.href='/checkout?sio=true&popup=true'}else{location.href='/checkout?sio=true'}})})}}/**
 * Embed Shipping Insurance checkbox
 * 
 * @param {boolean} isChecked True is needed to be checked, false if it is uncheck
 */function embeddedSI(isChecked){//console.log(shippingItem);
if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-section.si-section').length==0){if(isChecked){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-section').eq(1).before('<section class="cart-section optimizedCheckout-orderSumary-cartSection si-section"><input type="checkbox" id="enableSI" name="enableSI" checked="true" onChange="changeSI();"/><label for="enableSI" class="enableSI-label">Enable Shipping Insurance</label></section>')}else{__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-section').eq(1).before('<section class="cart-section optimizedCheckout-orderSumary-cartSection si-section"><input type="checkbox" id="enableSI" name="enableSI" onChange="changeSI();"/><label for="enableSI" class="enableSI-label">Enable Shipping Insurance</label></section>')}__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-section.si-section').find('input').on('change',function(){updateSI(this)})}}/**
 ...
 * @returns void
 */function cartRemoveSI(idx,shippingItems,callback){if(idx==shippingItems.length){callback()}else{__WEBPACK_IMPORTED_MODULE_2__bigcommerce_stencil_utils__["b" /* default */].api.cart.itemRemove(shippingItems[idx].id,function(err,removedData){if(err){return}cartRemoveSI(idx+1,shippingItems,callback)})}}/**
 * Check Shipping Insurance
 */function cartCheckSI(){var totalAmount=cartItems.baseAmount;shippingItems=findShippingInsurance(cartItems.lineItems.physicalItems);if(shippingItems){if(shippingItems.length>1){updateLoadingContent('Updating Shipping Insurance');var salePrice=shippingItems.reduce(function(a,b){return a+b.salePrice},0);var totalWithoutShipping=totalAmount-salePrice;cartRemoveSI(0,shippingItems,function(){if(totalWithoutShipping>=1000){var insurance=Math.floor(totalWithoutShipping*0.01);var url='/cart.php?action=add&sku=SKUSI-'+(insurance-9);__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(url,function(data){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}})}else{if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}}})}else{var _salePrice=shippingItems[0].salePrice;var _totalWithoutShipping=totalAmount-_salePrice;var insurance=Math.floor(_totalWithoutShipping*0.01);if(insurance!=Math.ceil(_salePrice)){updateLoadingContent('Updating Shipping Insurance');cartRemoveSI(0,shippingItems,function(){if(_totalWithoutShipping>=1000){var url='/cart.php?action=add&sku=SKUSI-'+(insurance-9);__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(url,function(data){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}})}else{if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}}})}else{hideLoading();if(_totalWithoutShipping>=1000&&_totalWithoutShipping<2000){embeddedSI(true)}if(teamdeskItems){cartSetDelivery()}else{cartGetDelivery()}}}}else{if(totalAmount>=1000&&totalAmount<2000){var _sioParam=getParameterByName('sio');if(_sioParam){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#cart-edit-link').attr('href','/cart.php?sio=true');hideLoading();if(teamdeskItems){cartSetDelivery()}else{cartGetDelivery()}embeddedSI(false)}else{var _insurance=Math.floor(totalAmount*0.01);var url='/cart.php?action=add&sku=SKUSI-'+(_insurance-9);updateLoadingContent('Updating Shipping Insurance');__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(url,function(data){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}})}}else if(totalAmount>=2000){var _insurance2=Math.floor(totalAmount*0.01);if(_insurance2<=106){var _url='/cart.php?action=add&sku=SKUSI-'+(_insurance2-9);updateLoadingContent('Updating Shipping Insurance');__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get(_url,function(data){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}})}else{hideLoading();if(teamdeskItems){cartSetDelivery()}else{cartGetDelivery()}}}else{hideLoading();if(teamdeskItems){cartSetDelivery()}else{cartGetDelivery()}}}}/**
 * Get and Check the products of cart
 */function checkProducts(){var token=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[name=store-token]').val();console.log(cartItems);if(cartItems){var ids=cartItems.lineItems.physicalItems.map(function(i){return i.productId});fetch('/graphql',{method:'POST',headers:{'Content-Type':'application/json','Authorization':'Bearer '+token},body:JSON.stringify({query:'\n            query SeveralProductsByID {\n                site {\n                    products(entityIds: ['+ids.join(',')+']) {\n                        edges {\n                            node {\n                                name\n                                sku\n                                entityId\n                                metafields (namespace: "shipping.shipperhq") {\n                                    edges {\n                                        node {\n                                            key\n                                            value\n                                        }\n                                    }\n                                }\n                            }\n                        }\n                    }\n                }\n            }\n            '})}).then(function(data){return data.json()}).then(function(data){if(data.data){for(var _iterator3=data.data.site.products.edges,_isArray3=Array.isArray(_iterator3),_i3=0,_iterator3=_isArray3?_iterator3:_iterator3[Symbol.iterator]();;){var _ref4;if(_isArray3){if(_i3>=_iterator3.length)break;_ref4=_iterator3[_i3++]}else{_i3=_iterator3.next();if(_i3.done)break;_ref4=_i3.value}var product=_ref4;var shippingGroup=null;if(product.node.metafields.edges.length>0){for(var _iterator5=product.node.metafields.edges,_isArray5=Array.isArray(_iterator5),_i5=0,_iterator5=_isArray5?_iterator5:_iterator5[Symbol.iterator]();;){var _ref6;if(_isArray5){if(_i5>=_iterator5.length)break;_ref6=_iterator5[_i5++]}else{_i5=_iterator5.next();if(_i5.done)break;_ref6=_i5.value}var group=_ref6;if(group.node.key=='shipping-groups'){shippingGroup=group.node.value;break}}}pShippingGroup[product.node.entityId]=shippingGroup}var totalSI=0,totalhp=0;for(var _iterator4=cartItems.lineItems.physicalItems,_isArray4=Array.isArray(_iterator4),_i4=0,_iterator4=_isArray4?_iterator4:_iterator4[Symbol.iterator]();;){var _ref5;if(_isArray4){if(_i4>=_iterator4.length)break;_ref5=_iterator4[_i4++]}else{_i4=_iterator4.next();if(_i4.done)break;_ref5=_i4.value}var _item=_ref5;if(_item.sku.includes('SKUSI')){totalSI+=_item.salePrice}else{if(pShippingGroup[_item.productId]){if(pShippingGroup[_item.productId].toLowerCase().includes('hairpiece')){totalhp+=_item.quantity}}}}setShipment(cartItems.baseAmount-totalSI>500||totalhp>2)}else{setShipment()}}).catch(function(error){console.error(error);setShipment()})}}/**
 * Check and set shipment
 * 
 * @param {boolean} isLarger True if having more than 2 pieces of hairpieces or subtotal larger than 500
 */function setShipment(){var isLarger=arguments.length>0&&arguments[0]!==undefined?arguments[0]:false;var group=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[name=customer-group]').val();switch(group){case'Newcomer':if(isLarger){if(isPopup==false){__WEBPACK_IMPORTED_MODULE_1_sweetalert2___default()({text:'As a new client, some restrictions are placed on your account for your first three orders. After your first three orders, restrictions on your cart total will be removed. If you would like to pay using a credit card, please reduce your cart total to under $500.00, or reduce the number of hairpieces in your cart to 2 or less.',type:'info'});isPopup=true}setInterval(function(){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').length>0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').find('li.form-checklist-item').filter(function(){return __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.paymentProviderHeader-name').eq(0).text().toLowerCase().includes('credit card')||__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('#radio-applepay').length>0}).css('display','none');if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').length>0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.checkout-view-content').length==0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.checkout-view-content').length==0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--customer').find('.checkout-view-content').length==0){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.country-name').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.country-name').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.address-line-1').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.address-line-1').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.locality').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.locality').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.postal-code').text().replaceAll(' ','')!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.postal-code').text().replaceAll(' ','')||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.region').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.region').text()){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').remove();__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('button[type=\'button\']').trigger('click');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.checkout-view-header').after('<div class=\'billing-reminder\'>Billing address should be the same as shipping address</div>');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').css({'margin-left':'4.19231rem','color':'#b30000','font-size':'1.2rem'})}else{__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').remove()}}},500)}else{setInterval(function(){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').length>0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.checkout-view-content').length==0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.checkout-view-content').length==0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--customer').find('.checkout-view-content').length==0){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.country-name').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.country-name').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.address-line-1').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.address-line-1').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.locality').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.locality').text()||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.postal-code').text().replaceAll(' ','')!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.postal-code').text().replaceAll(' ','')||__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.region').text()!=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.region').text()){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').remove();__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('button[type=\'button\']').trigger('click');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--billing').find('.checkout-view-header').after('<div class=\'billing-reminder\'>Billing address should be the same as shipping address</div>');__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').css({'margin-left':'4.19231rem','color':'#b30000','font-size':'1.2rem'})}else{__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.billing-reminder').remove()}}},500)}break;case'Blocklist':setInterval(function(){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').length>0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').find('li.form-checklist-item').filter(function(){return __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.paymentProviderHeader-name').eq(0).text().toLowerCase().includes('credit card')||__WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('#radio-applepay').length>0}).css('display','none')},500);break;}}/**
 * Besure some postal code could pay by cash, not all
 */function ruleCash(){setInterval(function(){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.postal-code').length>0){var dlvrZip='L3P,L3R,L3S,L3T,L4B,L4C,L4H,L4J,L4K,L4L,L4T,L4V,L4W,L4X,L4Y,L4Z,L5A,L5B,L5C,L5E,L5G,L5H,L5J,L5K,L5L,L5M,L5N,L5P,L5R,L5S,L5T,L5V,L5W,L6B,L6C,L6E,L6G,L6H,L6J,L6K,L6L,L6M,L6T,L6V,L6W,L6X,L6Y,L6Z,M1B,M1C,M1E,M1G,M1H,M1J,M1K,M1L,M1M,M1N,M1P,M1R,M1S,M1T,M1V,M1W,M1X,M2H,M2J,M2K,M2L,M2M,M2N,M2P,M2R,M3A,M3B,M3C,M3H,M3J,M3K,M3L,M3M,M3N,M4A,M4B,M4C,M4E,M4G,M4H,M4J,M4K,M4L,M4M,M4N,M4P,M4R,M4S,M4T,M4V,M4W,M4X,M4Y,M5A,M5B,M5C,M5E,M5G,M5H,M5J,M5K,M5L,M5M,M5N,M5P,M5R,M5S,M5T,M5V,M5W,M5X,M6A,M6B,M6C,M6E,M6G,M6H,M6J,M6K,M6L,M6M,M6N,M6P,M6R,M6S,M7A,M7Y,M8V,M8W,M8X,M8Y,M8Z,M9A,M9B,M9C,M9L,M9M,M9N,M9P,M9R,M9V,M9W';var tzip=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.postal-code').text().trim().substr(0,3);var tcountry=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--shipping').find('.country-name').text();if(dlvrZip.includes(tzip.toUpperCase())==false||tcountry.toLowerCase().includes('canada')==false){__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').length>0&&__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.checkout-step--payment').find('.checkout-view-content').find('li.form-checklist-item').filter(function(){return __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).find('.paymentProviderHeader-name').eq(0).text().toLowerCase().includes('cash')}).css('display','none')}}},500)}window.addEventListener('DOMContentLoaded',function(){var _this=this;xhook.after(function(request,response){//  console.log('xhook after ' + request.url);
if(request.url.match(/\/internalapi\/v1\/checkout\/customer$/)){if(status=200){if(isPopup){location.href='/checkout?popup=true'}else{location.href='/checkout'}}}});showLoading('Checking Shipping Insurance');__WEBPACK_IMPORTED_MODULE_2__bigcommerce_stencil_utils__["b" /* default */].api.cart.getCart({},function(err,myCart){if(err){return}if(myCart.length>0){var academy=myCart[0].lineItems.physicalItems.filter(function(item){return item.sku=='academymono'||item.sku=='academylace'||item.sku=='academyskin'||item.sku=='academyExtended'||item.sku=='academyStarter'});if(academy.length>0){var sum_academy=academy.reduce(function(a,b){return a+b.salePrice},0);myCart[0].baseAmount=myCart[0].baseAmount-sum_academy}cartItems={id:myCart[0].id,baseAmount:myCart[0].baseAmount,lineItems:myCart[0].lineItems};var popup=getParameterByName('popup');if(popup){isPopup=true}var group=__WEBPACK_IMPORTED_MODULE_0_jquery___default()('[name=customer-group]').val();if(group){if(group=='Blocklist'){setShipment()}else{checkProducts()}}// ruleCash();
var checkInit=setInterval(function(){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('#cart-edit-link').length>0&&'.cart-section'.length>0){_this.clearInterval(checkInit);cartCheckSI();var baction=setInterval(function(){if(__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-actions button').length>0){clearInterval(baction);__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.cart-actions button').on('click',function(){setTimeout(function(){cartSetDelivery()},500)})}},500)}},500)}})});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_eventemitter2__ = __webpack_require__(98);
...
/******/ });
//# sourceMappingURL=theme-bundle.checkout.js.map