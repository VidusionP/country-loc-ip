  ...
  <div id="columnThree">
    <div class="tape-subtitle">
      <div class="tape-subtitle-text">
        ...
        <div>Super tape<br/>(Rolls & Strips)</div>
      </div>     
  ...
  <div id="columnFour">
    <div class="tape-subtitle">
      <div class="tape-subtitle-text">
        ...
        <div>Ultra Hold<br/>(Rolls & Strips)</div>
      </div>
  ...
  <div id="columnSix">
    <div class="tape-subtitle">
      <div class="tape-subtitle-text">
        ...
        <div>Stick It<br/>(Strips Only)</div>
      </div>   
  ...
  <div id="columnSeven" >
    <div class="tape-subtitle" style="border-right: 1px solid #C4C4C4;">
      <div class="tape-subtitle-text">
        ...
        <div>MAX Grip Tape Strips/MAX Grab Tape Tabs</div>
      </div>  
      ...
      <div  class="tape-mobile-content">
          <div class="tape-mobile-split">
            <div class="tape-mobile-split-2" style="grid-template-columns: 1fr 17fr 20fr">
              ...
              <div class="tape-mobile-subtitle">Vapon Topstick Blue</div>
      ...
      <div class="tape-mobile-content">
        <div class="tape-mobile-split">
          <div class="tape-mobile-split-2" style="grid-template-columns: 1fr 8fr 20fr">
            <div class="tape-mobile-subtitle" style="margin-left: 2vw;"><li></li></div>
            <div class="tape-mobile-subtitle">Super Tape<br/>(Rolls & Strips)</div>
            <div style="    display: flex;
            justify-content: flex-end;
      ...
      <div class="tape-mobile-content">
        <div class="tape-mobile-split">
          <div class="tape-mobile-split-2" style="grid-template-columns: 1fr 12fr 20fr">
            <div class="tape-mobile-subtitle" style="margin-left: 2vw;"><li></li></div>
            <div class="tape-mobile-subtitle">Ultra Hold<br/>(Rolls & Strips)</div>
            <div style="    display: flex;
            justify-content: flex-end;
    ...
    <div id="itemFour">
      <div class="tape-mobile-content">
        <div class="tape-mobile-split">
          <div class="tape-mobile-split-2"  style="grid-template-columns: 1fr 17fr 20fr">
            <div class="tape-mobile-subtitle" style="margin-left: 2vw;"><li></li></div>
            <div class="tape-mobile-subtitle">Extendabond<br/>(Strips)</div>
            <div style="    display: flex;
            justify-content: flex-end;
      ...
      <div class="tape-mobile-content">
        <div class="tape-mobile-split">
          <div class="tape-mobile-split-2" style="grid-template-columns: 1fr 25fr 10fr">
            <div class="tape-mobile-subtitle" style="margin-left: 2vw;"><li></li></div>
            <div class="tape-mobile-subtitle">Stick It<br/>(Strips Only)</div>
            <div style="    display: flex;
            justify-content: flex-end;
      ...
      <div class="tape-mobile-content">
        <div class="tape-mobile-split">
          <div class="tape-mobile-split-2" style="grid-template-columns: 1fr 20fr 20fr">
            <div class="tape-mobile-subtitle" style="margin-left: 2vw;"><li></li></div>
            <div class="tape-mobile-subtitle">MAX Grip Tape Strips/MAX Grab Tape Tabs</div>
            <div style="    display: flex;
            justify-content: flex-end;
